...
def load_articles(user=None):
    ...
    try:
        ...
        article.article_type = utils.get_or_create_article_type(xmltree=xmltree, user=user)
        ...
        article.researchers.set(utils.get_or_create_researchers(xmltree=xmltree, user=user))
        article.keywords.set(utils.get_or_create_keywords(xmltree=xmltree, user=user))
        article.toc_sections.set(utils.get_or_create_toc_sections(xmltree=xmltree, user=user))
