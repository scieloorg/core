...
class ArticleFormatModelTest(TestCase):
    def setUp(self):
        ...
        self.test_file = SimpleUploadedFile(
            "test_file.xml",
            b"<article><element>Test</element></article>",
            content_type="application/xml",
        )
        self.test_file2 = SimpleUploadedFile(
            "test_file2.xml",
            b"<article><element>Test2</element></article>",
            content_type="application/xml",
        )
...
class TasksConvertXmlFormatsTest(TestCase):
    def setUp(self):
        ...
        self.input_xml = etree.fromstring(
            "<article><element>Original PMC</element></article>"
        )
        self.modified_xml = etree.fromstring(
            "<article><element>Modified PMC</element></article>"
        )
