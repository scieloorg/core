    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Last update date')),
                ('submission_date', models.DateField(blank=True, max_length=20, null=True, verbose_name='Submission Date')),
                ('status', models.CharField(blank=True, choices=[('DATA_CREATED', 'DATA_CREATED'), ('SUBMITTED', 'SUBMITTED'), ('QUEUED', 'QUEUED'), ('DEPOSITED', 'DEPOSITED')], max_length=15, null=True, verbose_name='Status')),
                ('creator', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='doiregistration_creator', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('doi', models.ManyToManyField(blank=True, to='doi.DOI', verbose_name='DOI')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='doiregistration_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Updater')),
            ],
        ),
        migrations.AddIndex(
            model_name='doiregistration',
            index=models.Index(fields=['submission_date'], name='doi_doiregi_submiss_6d5f36_idx'),
        ),
        migrations.AddIndex(
            model_name='doiregistration',
