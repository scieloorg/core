...
"""
@celery_app.task(bind=True, name=_("provide_pid_for_opac_xml"))
...
@celery_app.task(bind=True, name=_("provide_pid_for_opac_xmls"))
def provide_pid_for_opac_xmls(
    ...
    while True:
        try:
            ...
            provide_pid_for_opac_xml.apply_async(args=(user.username, response["documents"]))
        except Exception as e:
