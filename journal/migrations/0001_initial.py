...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="officialjournal_creator",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="officialjournal_last_mod_user",
                        to=settings.AUTH_USER_MODEL,
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="SciELO Journal Title",
                    ),
                ),
                (
                    "short_title",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="scielojournal_creator",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Creator",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="scielojournal_last_mod_user",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Updater",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="mission_last_mod_user",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Updater",
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["issn_scielo"], name="journal_sci_issn_sc_bfe46e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scielojournal",
        ...
        migrations.AddIndex(
            model_name="scielojournal",
            index=models.Index(
                fields=["short_title"], name="journal_sci_short_t_54db21_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scielojournal",
            index=models.Index(
                fields=["submission_online_url"], name="journal_sci_submiss_fa957f_idx"
            ),
        ),
        migrations.AddIndex(
