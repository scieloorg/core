    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acron3', models.CharField(blank=True, max_length=10, null=True, verbose_name='Acronym with 3 chars')),
                ('acron2', models.CharField(blank=True, max_length=10, null=True, verbose_name='Acronym with 2 chars')),
                ...
                ('type', models.CharField(blank=True, choices=[('journals', 'Journals'), ('preprints', 'Preprints'), ('repositories', 'Repositories'), ('books', 'Books')], max_length=255, null=True, verbose_name='Tipo')),
                ...
                ('name', models.ManyToManyField(blank=True, max_length=255, to='collection.CollectionName', verbose_name='Collection Name')),
