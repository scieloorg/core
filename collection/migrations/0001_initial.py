    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('journals', 'Journals'), ('preprints', 'Preprints'), ('repositories', 'Repositories'), ('books', 'Books'), ('data', 'Data repository')], max_length=255, null=True, verbose_name='Tipo')),
