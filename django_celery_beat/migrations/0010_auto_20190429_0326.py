...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                default="*",
                help_text='Cron Days Of The Week to Run. Use "*" for "all". (Example: "0,5")',
                max_length=64,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                default="*",
                help_text='Cron Months Of The Year to Run. Use "*" for "all". (Example: "0,6")',
                max_length=64,
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Interval Schedule to run the task on.  Set only one schedule type, leave the others null.",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Solar Schedule to run the task on.  Set only one schedule type, leave the others null.",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
